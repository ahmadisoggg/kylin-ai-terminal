...
/**
 * Version compatibility utility for HeadStealX
 * Handles version detection and compatibility checks for Minecraft 1.8-1.21.8
 */
public class VersionUtil {
    ...
    private static final int MAX_PATCH = 8;
    ...
    /**
     * Check if current version is exactly the specified version
     */
    public static boolean isExactly(int major, int minor) {
        return VERSION_NUMBERS.length >= 2 && 
               VERSION_NUMBERS[0] == major && 
               VERSION_NUMBERS[1] == minor;
    }
    
    /**
     * Get the NMS version string for reflection
     */
    ...
    /**
     * Check if server supports adventure components (Paper 1.16+)
     */
